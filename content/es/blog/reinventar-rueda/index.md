---
title: "No todo está terminado"
subtitle: "Inventores por naturaleza"
description: 'Lo real se aprende haciendo: ninguna rueda ajena reemplaza la experiencia propia.'
excerpt: 'Lo real se aprende haciendo: ninguna rueda ajena reemplaza la experiencia propia.'
...
**Guiar** y **arruinar** son dos palabras que de antemano no parecerían tener nada en común, sin embargo, en algún momento todos experimentaremos la delgada línea que las puede llegar a separar: **la intención**. Un consejo o una crítica por lo general están inclinados hacia alguna de estas orillas:
...
El **no reinventes la rueda**, da por hecho que lo que tiene enfrente es una rueda. Asume que ya existe una solución perfecta, universal, cerrada; que explorar de primera mano es un desperdicio.

Pero esto rara vez es cierto. Y aquí es donde un ejemplo concreto puede ayudar a iluminar el error.

## De la rueda y los programas de computador

El siguiente fragmento de **Casey Muratori**, famoso entre otras cosas por su serie <a href="https://handmadehero.org/" target="_blank" rel="noopener noreferrer">Handmade Hero</a>, no es el argumento central del artículo, sino una lámpara que ilumina lo que hay detrás de *no reinventar la rueda*.
...
Conviene aclarar que esta no es una invitación a la <a href="/docs/espanol/palabras/#autarquía-" target="_blank">autarquía</a> ni a reinventarlo todo por capricho. Es, más bien, una llamada a explorar los confines de aquello que nos apasiona, a no dar las cosas por sentado, **a sustituir el dogma por conocimiento vivido**.

Recordar siempre que lo nuevo no se descubre obedeciendo las recetas del pasado, sino abriendo la mente, el cuerpo y el espíritu a la majestuosa vastedad de un universo infinito.
